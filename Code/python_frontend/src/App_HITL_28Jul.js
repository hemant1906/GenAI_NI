...
export default function App() {
  ...
  /* Human-In-The-Loop for Summary and Description */
                            ...
                            {!editMode ? (
                              <button
                                onClick={() => {
                                  ...
                                  setEditedDescription(responseData.description || '');
                                  setEditMode(true);
                                  setUpdateStatus('');
                                }}
                              >
                              ...
                              <div style={{ marginTop: '10px' }}>
                                <button
                                  onClick={async () => {
                                    try {
                                      const res = await fetch('http://localhost:7001/update_summary_description/', {
                                        method: 'POST',
                                        headers: { 'Content-Type': 'application/json' },
                                        body: JSON.stringify({
                                          diagram_id: responseData.diagram_id,
                                      ...
                                      setUpdateStatus(data.message || 'Updated successfully');
                                      setEditMode(false);
                                    } catch (error) {
                                      console.error('Update failed:', error);
                                      setUpdateStatus('Error updating summary/description');
                                    }
                                  }}
                                >
                                  ✅ Approve
